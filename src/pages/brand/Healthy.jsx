...
const Healthy = () => {
  ...
  return (
    <main>
      {/* Banner area start */}
      <section id="hero" className="banner-2__area p-relative overflow-hidden z-1 ourbrand">
        <div className="container custom-container-3 pt200">
          <div className="row">
            <div className="col-12">
              <div id="hero-caption" className="parallax-scroll-caption banner-2__content p-relative">
