...
const Ceo = () => {
  ...
  useEffect(() => {
    document.title = "CEO 소개 | 회사명";

    const desc = document.querySelector('meta[name="description"]');
    if (desc) {
      desc.setAttribute("content", "CEO 소개 페이지");
    } else {
      const meta = document.createElement("meta");
      meta.name = "description";
      meta.content = "CEO 소개 페이지";
    ...
    ogUrl.content = "https://hypark0232.gabia.io/prerendered/about/ceo";
  }, []);
  useEffect(() => {
    // 컴포넌트 마운트 후 애니메이션 시작
