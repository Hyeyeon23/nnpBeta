...
const root = createBrowserRouter(
  [
    ...
    },
    {
      ...
      element: (
        <Suspense fallback={Loading}>
          <RecruitLayout></RecruitLayout>
        </Suspense>
      ),
      children: [
        { path: "info", Component: RecruitInfo },
        { path: "policy", Component: PolicyInfo },
        { path: "process", Component: ProcessInfo },
        { path: "benefit", Component: BenefitInfo },
      ],
    },
    {
      path: "business",
